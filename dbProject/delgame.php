...
<body>
  ...
  <form id="delgameForm" action="func/delGame.php" method="POST">
	<?php
  ...
  for($i=0; $i<count($result); $i++){
    ...
    echo"<th scope='row'><input class=\"gameRadio\" type=\"radio\" name=\"mdfgame\" value=\"\" checked=\"\"><a class=\"radiohide\" style=\"margin-right:5px;\" href=\"#\"><span style=\"font-size: 4px;color:rgb(167,171,175);display:inline-block;\"><i class=\"far fa-trash-alt\"></i></span></a></th>";
  ...
  echo "</table>"
  ?>
  <input id="delwhichgame" type="hidden" name="delgame" value="">
  </form>
  ...
  <script type="text/javascript">
    ...
    var delcardform = document.querySelector("#delgameForm");
    var delcard = document.querySelector("#delwhichgame");
    lastclick = -1;
    ...
    for(j=0;j<a.length;j++){
        (function(j){
           a[j].addEventListener("click",function(){
              delcard.setAttribute("value",td[4*j].textContent);
              delcardform.submit();
           });
        })(j);
    }
