...
<body>
	<nav id="fixheight" class="navbar navbar-expand-lg navbar-light bg-light">
  		...
  		<form id="fixsearch" class="form-inline" action="func/fpsSearch.php" method="POST">
    		<input class="form-control mr-sm-2" type="search" name="fpsSearch" placeholder="Search Game" aria-label="Search">
    		<button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
  		</form>
	</nav>
  <form id="delfpsForm" action="func/delfps.php" method="POST">
	<?php
  ...
  for($i=0; $i<count($result); $i++){
    ...
    echo"<th scope='row'><input class=\"gameRadio\" type=\"radio\" name=\"mdffps\" value=\"\" checked=\"\"><a class=\"radiohide\" style=\"margin-right:5px;\" href=\"#\"><span style=\"font-size: 4px;color:rgb(167,171,175);display:inline-block;\"><i class=\"far fa-trash-alt\"></i></span></a></th>";
  ...
  echo "</table>"
  ?>
  <input id="delwhichfps" type="hidden" name="delfps" value="">
  </form>
  ...
  <script type="text/javascript">
    ...
    var delcardform = document.querySelector("#delfpsForm");
    var delcard = document.querySelector("#delwhichfps");
    lastclick = -1;
