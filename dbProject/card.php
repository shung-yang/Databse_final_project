...
<body>
  ...
  <div id ="icon" style="font-size: 0.5rem;">
    ...
    <button class="chgbtn"><i class="fas fa-trash-alt fa-5x"></i><a class="nav-link ad_del_a" href="delcard.php"></a></button>
    <button class="chgbtn"><i class="far fa-edit fa-5x"></i><a class="nav-link ad_del_a" href="mdfcard.php"></a></button>
  </div>
